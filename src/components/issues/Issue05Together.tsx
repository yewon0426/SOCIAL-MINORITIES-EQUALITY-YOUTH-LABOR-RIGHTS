    ...
    <article className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-16">
      ...
      <header className="border-b-2 border-[#1C1917] pb-8 space-y-4">
        <div className="flex items-center justify-between font-mono text-xs text-[#78716C]">
          ...
          <span>COLLECTIVE LABOR RIGHTS / THE 3 LABOR RIGHTS</span>
        </div>
        ...
        <div className="py-6 border-y-2 border-[#1C1917] text-center space-y-3 bg-[#FBF9F5]">
          ...
          <h1 className="text-4xl sm:text-6xl font-quote font-black tracking-tight text-[#1C1917] leading-tight">
            “우리, 같이 이야기합시다.”
          </h1>
          <p className="font-mono text-xs sm:text-sm tracking-[0.2em] text-[#57534E] uppercase pt-2">
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-2 border-b border-[#292524]/20 pb-2">
          ...
          <span className="text-xs font-mono text-[#78716C]">/ THE THREE FUNDAMENTAL LABOR RIGHTS (헌법 제33조)</span>
        </div>
            ...
            >
              <div>
                <div className="flex items-center justify-between border-b border-[#292524]/10 pb-2">
                  <span className="font-mono text-xs font-bold text-[#881337]">
                    {right.code}
                  </span>
                  <span className="stamp-box px-1.5 py-0.5 text-[9px]">헌법상 기본권</span>
                </div>
                <h3 className="text-2xl font-serif font-bold text-[#1C1917] mt-2">
                  {right.name}
                </h3>
                <p className="text-xs sm:text-sm font-sans text-[#44403C] mt-2 leading-relaxed">
                  {right.definition}
                </p>
              </div>

              <div className="pt-3 border-t border-[#292524]/10 text-[11px] font-mono text-[#78716C]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs font-bold text-[#881337] uppercase">CONNECT THE SCENES</span>
          ...
          {LABOR_RIGHT_SCENES.map((scene) => {
            ...
            return (
              ...
              >
                ...
                {currentMatch && (
                  <div className="pt-2 border-t border-[#292524]/10 text-xs text-[#57534E] flex items-center gap-2 font-sans animate-in fade-in duration-200">
                    <span className="font-mono text-[10px] text-[#881337] font-bold">
                      [READ THE NOTE]
                    </span>
                    <span>{scene.feedback}</span>
                  </div>
                )}
              </div>
            );
      ...
      <section className="p-8 sm:p-12 bg-white border-2 border-[#1C1917] space-y-8 text-center relative">
        <div className="max-w-2xl mx-auto space-y-4">
          <span className="stamp-box px-3 py-1 text-xs font-mono">
            PHILOSOPHICAL &amp; CONSTITUTIONAL INQUIRY
          </span>

          <h2 className="text-3xl sm:text-5xl font-serif font-black text-[#1C1917] leading-tight">
            “왜 헌법은 근로자에게 혼자가 아니라<br />
            <span className="text-[#881337] underline decoration-2 underline-offset-8">‘함께’</span> 행동할 권리까지 보장할까?”
          </h2>

          <p className="text-sm font-sans text-[#57534E] leading-relaxed pt-2">
            ...
            {TOGETHER_KEYWORDS.map((kw) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 text-xs sm:text-sm font-sans transition-all cursor-pointer border ${
                    isSelected
        ...
        <div className="pt-6 border-t border-[#292524]/10">
          <button
            ...
            className="px-6 py-3 bg-[#1C1917] hover:bg-[#881337] text-white text-xs font-serif font-bold tracking-widest uppercase transition-all cursor-pointer"
          >
