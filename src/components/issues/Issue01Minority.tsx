    ...
    <article className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-16">
      ...
      <header className="border-b-2 border-[#1C1917] pb-8">
        ...
        <div className="space-y-3">
          <h1 className="display-title text-5xl sm:text-7xl text-[#1C1917] leading-tight">
            MINORITY<br />
            <span className="text-[#881337] font-light">≠</span> FEW
          </h1>
          <p className="quote text-xl sm:text-2xl text-[#292524] pt-2">
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-2 border-b border-[#292524]/20 pb-2">
          ...
          <span className="editorial-meta text-[#78716C]">/ EDITORIAL COLUMN</span>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Main Newspaper Column */}
          <div className="lg:col-span-7 xl:col-span-8 space-y-6">
            <h2 className="editorial-heading text-[#1C1917]">
              WHAT MAKES A MINORITY?
            </h2>

            <div className="learning-body space-y-5">
              <p className="reading-text">
                <span className="float-left text-4xl sm:text-5xl font-editorial font-black text-[#881337] leading-none pr-2 pt-0.5 select-none">
                  사
                </span>
            ...
            <div className="my-8 py-5 px-6 sm:px-7 border-l-4 border-[#881337] bg-white/70">
              <blockquote className="quote text-[#1C1917] leading-relaxed">
                “10명 중 1명이라고 해서 자동으로 사회적 소수자가 되는 것은 아니다.”
              </blockquote>
              <cite className="block editorial-meta text-[#78716C] mt-2.5 not-italic tracking-wider">
            ...
            <div className="p-6 bg-white border border-[#292524]/20 space-y-4">
              <div className="flex items-center gap-2 border-b border-[#292524]/10 pb-2.5">
                ...
                <h3 className="card-title uppercase text-[#1C1917]">
                  DO NOT CONFUSE (혼동하지 말아야 할 점)
                </h3>
              </div>
              <ul className="space-y-3 learning-body text-[15px] sm:text-base text-[#292524]">
          ...
          <aside className="lg:col-span-5 xl:col-span-4 bg-[#F2EFE8] border border-[#292524]/15 p-5 sm:p-6 space-y-4">
            <div className="flex items-center justify-between border-b border-[#292524]/20 pb-2">
              ...
              <span className="editorial-meta text-[#78716C]">#CRITERIA</span>
            </div>
            ...
            <ol className="space-y-3">
              <li className="p-3 bg-white/80 border border-[#292524]/10 shadow-2xs">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="card-title text-sm text-[#1C1917]">식별 가능성</span>
                </div>
                <p className="card-body text-[13.5px] sm:text-sm text-[#44403C]">
              ...
              <li className="p-3 bg-white/80 border border-[#292524]/10 shadow-2xs">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="card-title text-sm text-[#1C1917]">권력의 열세</span>
                </div>
                <p className="card-body text-[13.5px] sm:text-sm text-[#44403C]">
              ...
              <li className="p-3 bg-white/80 border border-[#292524]/10 shadow-2xs">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="card-title text-sm text-[#1C1917]">차별적 대우</span>
                </div>
                <p className="card-body text-[13.5px] sm:text-sm text-[#44403C]">
              ...
              <li className="p-3 bg-white/80 border border-[#292524]/10 shadow-2xs">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="card-title text-sm text-[#1C1917]">집단적 정체성</span>
                </div>
                <p className="card-body text-[13.5px] sm:text-sm text-[#44403C]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="editorial-label text-[#881337]">SCENE 01</span>
            <span className="scene-title">
              「우리 학교 왼손잡이는 5%뿐입니다.」
            </span>
          </div>
          <span className="editorial-meta text-[#78716C]">CASE ANALYSIS</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-7 space-y-3 text-[#292524]">
            <p className="quote text-[16px] sm:text-[17px] bg-[#FBF9F5] p-4 sm:p-5 border border-[#292524]/10 text-[#1C1917]">
              “전체 학생 중 왼손잡이 학생은 약 5%에 불과하다.”
            </p>
            <div className="learning-question pt-1">
          ...
          <div className="md:col-span-5 bg-[#F9F7F1] p-4 sm:p-5 border border-[#292524]/15 space-y-3">
            <div className="flex items-center gap-2 editorial-label text-[#57534E]">
        ...
        <div className="pt-3 border-t border-[#292524]/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <button
            ...
            className="learning-btn px-5 py-2.5 border border-[#1C1917] bg-[#1C1917] hover:bg-[#881337] text-white tracking-wider transition-all cursor-pointer"
          >
        ...
        {scene01State.checkedConcept && (
          <div className="mt-4 p-5 sm:p-6 bg-[#F2EFE8] border-l-4 border-[#881337] space-y-2.5 animate-in fade-in duration-300">
            ...
            <p className="learning-body text-[#1C1917]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          ...
          <span className="editorial-meta text-[#78716C]">EVIDENCE MARKING</span>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-7 xl:col-span-8 space-y-6">
            <p className="learning-instruction text-[#57534E]">
              <strong className="editorial-label text-[#881337]">MARK THE EVIDENCE :</strong> 아래 인용문에서 판단에 중요한 표현을 클릭하여 형광펜을 칠해보세요.
            </p>

            {/* Clickable interactive sentence */}
            <div className="p-6 sm:p-8 bg-[#FBF9F5] border border-[#292524]/15 rounded-xs">
              <div className="quote text-2xl sm:text-3xl text-[#1C1917] leading-loose flex flex-wrap gap-2 items-baseline">
                <span>“</span>
            ...
            <div className="space-y-3">
              <label htmlFor="scene02-input" className="block editorial-label text-[#57534E]">
          ...
          <aside className="lg:col-span-5 xl:col-span-4 bg-[#F2EFE8] border border-[#292524]/15 p-5 sm:p-6 space-y-4">
            <div className="border-b border-[#292524]/20 pb-2">
              ...
              <span className="learning-instruction text-[#57534E] mt-1 block">
            ...
            <ul className="space-y-3">
              <li className="p-3 bg-white/80 border border-[#292524]/10 space-y-1 shadow-2xs">
                <span className="card-title text-sm text-[#1C1917] block">① 다른 대우가 있는가?</span>
                <span className="card-body text-xs sm:text-[13px] text-[#57534E] block">‘잘 안 뽑는다’는 실질적인 채용 배제 행위가 존재합니다.</span>
              </li>
              <li className="p-3 bg-white/80 border border-[#292524]/10 space-y-1 shadow-2xs">
                <span className="card-title text-sm text-[#1C1917] block">② 무엇을 이유로 다른 대우를 하는가?</span>
                <span className="card-body text-xs sm:text-[13px] text-[#57534E] block">‘학생들은 책임감이 부족하다’는 일반화된 편견에 기인합니다.</span>
              </li>
              <li className="p-3 bg-white/80 border border-[#292524]/10 space-y-1 shadow-2xs">
                <span className="card-title text-sm text-[#1C1917] block">③ 그 이유가 합리적이고 정당한가?</span>
                <span className="card-body text-xs sm:text-[13px] text-[#57534E] block">개인의 실제 능력이나 근무 태도를 검증하지 않고 집단 전체를 재단하므로 합리성을 결여하고 있습니다.</span>
              </li>
            </ul>

            <div className="pt-2 editorial-meta text-[#78716C] not-italic leading-normal">
