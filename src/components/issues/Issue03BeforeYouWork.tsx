    ...
    <article className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-16">
      ...
      <header className="relative border-b-2 border-[#1C1917] pb-8 bg-[#F4F0E6] p-6 sm:p-10 border border-[#292524]/20 shadow-xs">
        <div className="absolute top-4 right-4 flex items-center gap-2">
          ...
          <span className="stamp-box px-2.5 py-1 editorial-meta bg-white">
            DOSSIER #W-003
          </span>
        </div>

        <div className="editorial-label text-[#78716C] mb-3">
          <span>EMPLOYMENT RECORD / BEFORE YOU WORK</span>
        </div>

        <div className="space-y-3">
          <h1 className="display-title text-5xl sm:text-7xl text-[#1C1917] leading-none">
            BEFORE<br />
            YOU WORK
          </h1>
          <p className="editorial-quote text-xl sm:text-2xl text-[#881337] pt-2">
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-2 border-b border-[#292524]/20 pb-2">
          ...
          <span className="editorial-meta text-[#78716C]">/ FUNDAMENTAL LABOR STATUS</span>
        </div>

        {/* Big Statement Banner */}
        <div className="p-6 sm:p-8 bg-white border border-[#292524]/20 space-y-4 text-center">
          <p className="editorial-label text-[#78716C]">
            청소년 노동권을 이해하기 전에 먼저 기억해야 할 사실이 있습니다.
          </p>
          <div className="editorial-heading text-3xl sm:text-5xl text-[#1C1917]">
            “청소년도 <span className="text-[#881337] underline decoration-2 underline-offset-8">‘근로자’</span>입니다.”
          </div>
          <p className="learning-body text-[#44403C] max-w-2xl mx-auto pt-2">
        ...
        <div className="p-6 bg-[#FBF9F5] border border-[#292524]/20 space-y-4">
          <div className="flex items-center gap-2 border-b border-[#292524]/15 pb-2">
            <span className="editorial-label text-[#881337]">FILE NOTE</span>
            <h3 className="editorial-subheading text-sm sm:text-base text-[#1C1917]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="editorial-label text-[#881337]">DOCUMENT 01</span>
            <span className="scene-title">
              「표준 근로계약서」
            </span>
          </div>
          <span className="editorial-meta text-[#78716C]">MARK THE DOCUMENT</span>
        </div>

        <div>
          <p className="learning-question mb-1">
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between p-3.5 bg-[#FBF9F5] border border-[#292524]/15 editorial-meta">
            <div className="flex items-center gap-2">
          ...
          {isCardUnlocked && (
            <div className="p-6 bg-[#FEF2F2] border-2 border-[#B91C1C] space-y-3 animate-in fade-in duration-300">
              <div className="flex items-center justify-between border-b border-[#B91C1C]/20 pb-2">
                <span className="stamp-box px-2 py-0.5 editorial-label text-[#B91C1C] border-[#B91C1C]">
        ...
        <div className="border border-[#292524]/30 bg-[#FFFDF9] p-6 sm:p-8 shadow-xs relative">
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    {isMarked ? (
                      ...
                      <span className="editorial-meta text-[11px] text-[#A8A29E] shrink-0">
                        [ 클릭하여 확인 ]
                      </span>
                    )}
                  </div>
          ...
          <div className="mt-6 pt-4 border-t border-dashed border-[#292524]/20 p-4 bg-[#F9F7F1] text-xs text-[#44403C] space-y-1.5">
            ...
            <p className="learning-instruction text-[#44403C]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="editorial-label text-[#881337]">SCENE 05</span>
            <span className="scene-title">
              「손님 없을 때 앉아 있었잖아」
            </span>
          </div>
          <span className="editorial-meta text-[#78716C]">BREAK TIME VS WAITING TIME</span>
        </div>

        {/* Short dialogue interview */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 bg-[#FBF9F5] border border-[#292524]/15 space-y-1">
            <span className="editorial-label text-[#78716C]">
              EMPLOYER (사장)
            </span>
            <p className="card-title text-base sm:text-lg text-[#1C1917]">
        ...
        <div className="py-2">
          <p className="learning-question text-base sm:text-lg">
        ...
        <div className="space-y-3">
          <p className="editorial-label text-[#57534E]">
        ...
        <div className="space-y-2">
          <label htmlFor="rest-time-input" className="block editorial-label text-[#57534E]">
            MY SUMMARY / 나의 메모
          </label>
          <input
            id="rest-time-input"
