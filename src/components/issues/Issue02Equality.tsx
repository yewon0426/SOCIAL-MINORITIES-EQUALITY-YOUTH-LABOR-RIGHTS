    ...
    <article className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-16">
      ...
      <header className="border-b-2 border-[#1C1917] pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[#1C1917]/20 pt-4">
          <div className="pb-6 md:pb-0 md:pr-8 space-y-2">
            ...
            <h1 className="display-title text-5xl sm:text-6xl text-[#1C1917]">
              SAME
            </h1>
            <p className="quote text-lg sm:text-xl text-[#292524]">
          ...
          <div className="pt-6 md:pt-0 md:pl-8 space-y-2">
            ...
            <h1 className="display-title text-5xl sm:text-6xl text-[#881337]">
              EQUAL?
            </h1>
            <p className="learning-question text-lg sm:text-xl text-[#881337]">
      ...
      <section className="space-y-8">
        <div className="flex items-center gap-2 border-b border-[#292524]/20 pb-2">
          ...
          <span className="editorial-meta text-[#78716C]">/ THE TWO DIMENSIONS OF EQUALITY</span>
        </div>

        {/* Centerpiece typography banner */}
        <div className="text-center py-6 border-y border-[#292524]/15 bg-white/50">
          <p className="display-title text-3xl sm:text-5xl tracking-widest text-[#1C1917] uppercase">
            SAME <span className="text-[#881337] font-light">≠</span> ALWAYS FAIR
          </p>
          <p className="quote text-base sm:text-lg text-[#292524] mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="p-6 bg-white border border-[#292524]/20 space-y-4 relative">
            <div className="flex items-center justify-between border-b border-[#292524]/10 pb-3">
              <span className="editorial-label text-[#57534E]">
                FORMAL EQUALITY
              </span>
              <span className="stamp-box px-2 py-0.5 text-[10px]">기계적·절대적 평등</span>
            </div>
            <h3 className="editorial-heading text-2xl text-[#1C1917]">
              형식적 평등
            </h3>
            <p className="learning-body text-[#44403C]">
              모든 사람에게 처한 상황이나 차이에 관계없이 <strong>동일한 기준과 규칙, 기회를 기계적으로 적용</strong>하는 것을 중시합니다.
            </p>
            <div className="p-3.5 bg-[#FBF9F5] border border-[#292524]/10 learning-instruction text-[#57534E]">
          ...
          <div className="p-6 bg-white border-2 border-[#881337]/30 space-y-4 relative">
            ...
            <h3 className="editorial-heading text-2xl text-[#881337]">
              실질적 평등
            </h3>
            <p className="learning-body text-[#44403C]">
              사람들이 처한 서로 다른 조건과 기존의 사회적·신체적 불리함을 고려하여 <strong>실질적으로 동등한 기회와 결과를 보장</strong>하는 것을 중시합니다.
            </p>
            <div className="p-3.5 bg-[#881337]/5 border border-[#881337]/20 learning-instruction text-[#57534E]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="editorial-label text-[#881337]">SCENE 03</span>
            <span className="scene-title">
              「건물 출입구의 계단」
            </span>
          </div>
          <span className="editorial-meta text-[#78716C]">DUAL LENS PERSPECTIVE</span>
        </div>
        ...
        <div className="bg-[#FBF9F5] p-5 border border-[#292524]/15 space-y-2">
          ...
          <blockquote className="learning-question text-base sm:text-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center justify-between editorial-label mb-1">
              ...
              <span className="card-body text-xs text-[#A8A29E] block mt-2">
            ...
            >
              ...
              <span className="card-body text-xs text-rose-100 block mt-2">
        ...
        <div className="pt-4 border-t border-[#292524]/10 space-y-2">
          <label htmlFor="stair-reflection-input" className="block editorial-label text-[#57534E]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="editorial-label text-[#881337]">SCENE 04</span>
            <span className="editorial-heading text-lg sm:text-xl text-[#1C1917]">
              SPECIAL TREATMENT?
            </span>
          </div>
          <span className="editorial-meta text-[#78716C]">CRITICAL REFLECTION</span>
        </div>

        <div className="space-y-3">
          <h3 className="scene-title text-xl sm:text-2xl text-[#1C1917]">
            「장애 학생에게 시험 편의(시간 연장, 점자 시험지)를 제공했습니다.」
          </h3>
          <p className="learning-question text-base text-[#881337]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            <span className="editorial-label text-[#78716C] block">
              FORMAL PERSPECTIVE
            </span>
            <h4 className="card-title text-sm text-[#1C1917] mt-1">
              모든 학생에게 완전히 동일한 조건 적용
            </h4>
            <p className="card-body text-xs text-[#57534E] mt-2">
          ...
          >
            ...
            <h4 className="card-title text-sm text-[#881337] mt-1">
        ...
        <div className="space-y-2">
          <label htmlFor="special-treatment-input" className="block editorial-label text-[#57534E]">
      ...
      <section className="p-6 sm:p-8 bg-white border border-[#292524]/20 shadow-2xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#292524]/10 pb-3">
          <div className="flex items-center gap-2">
            <span className="editorial-label text-[#881337]">PRACTICE FILE</span>
            <span className="scene-title">
          ...
          return (
            <div className="space-y-6">
              ...
              <div className="p-4 bg-[#FBF9F5] border border-[#292524]/15 space-y-3">
                <div className="flex items-center justify-between editorial-label">
                  <span className="text-[#881337]">CASE A</span>
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <button
                    ...
                    className={`learning-btn py-2 px-3 text-xs border transition-all cursor-pointer ${
                      answers.a === 'formal'
              ...
              <div className="p-4 bg-[#FBF9F5] border border-[#292524]/15 space-y-3">
                <div className="flex items-center justify-between editorial-label">
                  <span className="text-[#881337]">CASE B</span>
              ...
              <div className="p-4 bg-[#FBF9F5] border border-[#292524]/15 space-y-3">
                <div className="flex items-center justify-between editorial-label">
                  <span className="text-[#881337]">CASE C</span>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <button
                  ...
                  className={`learning-btn px-6 py-3 tracking-wider transition-all cursor-pointer ${
                    allSelected
              ...
              {hasSubmitted && (
                <div className="p-5 bg-[#F2EFE8] border-l-4 border-[#881337] space-y-3 animate-in fade-in duration-300">
                  ...
                  <div className="space-y-2 learning-body text-xs sm:text-sm text-[#292524]">
                    <p>
