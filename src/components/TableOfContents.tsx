    ...
    <div className="py-12 px-4 sm:px-10 max-w-5xl mx-auto">
      ...
      <div className="border-b-2 border-[#1C1917] pb-4 mb-10 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h2 className="display-title text-3xl sm:text-5xl text-[#1C1917] mt-1">
            TABLE OF CONTENTS
          </h2>
        </div>
        <div className="text-right">
          <span className="editorial-meta text-xs text-[#78716C] block">
            ISSUE 01 / 2026 EDITION
          </span>
          <span className="learning-body text-xs text-[#57534E]">
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <span className="display-title text-3xl sm:text-4xl text-[#881337]/70 group-hover:text-[#881337] transition-colors leading-none">
                  {item.issueNumber}
                </span>
                <span className="editorial-label text-[10px] border border-[#292524]/20 px-2 py-0.5 text-[#57534E]">
                  {item.tag}
                </span>
              </div>

              <div className="mt-4">
                <h3 className="editorial-subheading text-lg sm:text-xl text-[#1C1917] group-hover:text-[#881337] transition-colors">
                  {item.englishTitle}
                </h3>
                <p className="learning-body text-sm text-[#44403C] mt-1.5 leading-relaxed">
                  {item.koreanQuestion}
                </p>
              </div>

              <div className="mt-6 pt-4 border-t border-[#292524]/10 flex items-center justify-between text-xs editorial-meta">
      ...
      <div className="mt-8 p-6 border-2 border-dashed border-[#881337]/50 bg-[#881337]/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="stamp-box px-2 py-0.5 text-[10px] editorial-meta">MY PORTFOLIO</span>
            <span className="editorial-meta text-xs text-[#881337] font-semibold">RIGHTS FILE : MY EDITION</span>
          </div>
          <h4 className="editorial-subheading text-lg text-[#1C1917]">
            내가 발견한 권리의 장면들과 최종 기록 포스터
          </h4>
          <p className="learning-body text-xs text-[#57534E]">
        ...
        <button
          ...
          className="learning-btn whitespace-nowrap px-5 py-2.5 bg-[#881337] hover:bg-[#1C1917] text-white tracking-wider transition-all cursor-pointer shadow-xs"
        >
          VIEW MY EDITION →
        </button>
      </div>
